...
# ---------Клавиатуры---------
keyboard_mem = VkKeyboard(one_time=True)
keyboard_like = VkKeyboard(one_time=True)

# ----Кнопки----
keyboard_mem.add_button('Мем', color=VkKeyboardColor.PRIMARY)
keyboard_like.add_button('Лайк', color=VkKeyboardColor.POSITIVE)
keyboard_like.add_button('Дизлайк', color=VkKeyboardColor.NEGATIVE)
